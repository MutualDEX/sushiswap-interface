                ...
                <Card className="h-full bg-dark-900">
                    <div className="flex-col space-y-2">
                        ...
                        <div className="flex justify-between pt-3">
                            <div className="text-xl text-high-emphesis">{i18n._(t`BigVault`)}</div>
                        </div>
                        <div className="flex justify-between">
                            ...
                            <div className="text-lg text-high-emphesis">
                                ...
                                <QuestionHelper
                                    text={i18n._(
                                        t`BigVault strategies can create yield for your collateral tokens. This token does not yet have a strategy in the BigVault.`
                                    )}
                                />
                            </div>
                        </div>
