...
export default function BentoBalances(): JSX.Element {
    ...
    return (
        <>
            <Helmet>
                <title>BigVault Balances | Bigswap</title>
            </Helmet>
            <Layout
                left={
                    <Card
                        ...
                        title={i18n._(t`Deposit tokens into the BigVault for all the yields`)}
                        description={i18n._(
                            t`BigVault provides extra yield on deposits with flash lending, strategies, and fixed, low-gas transfers among integrated dapps, like BigBucks markets`
                        )}
                    />
                }
            >
                        ...
                        <CardHeader className="flex justify-between items-center bg-dark-800">
                            <div className="flex flex-col md:flex-row items-center justify-between w-full">
                                <div className="flex items-baseline">
                                    <div className="text-3xl text-high-emphesis mr-4">{i18n._(t`BigVault`)}</div>
                                </div>
                ...
                >
                    <div className="grid gap-4 grid-flow-row auto-rows-max">
                        <div className="px-4 grid grid-cols-3 text-sm  text-secondary select-none">
                            ...
                            <div className="text-right">{i18n._(t`BigVault`)}</div>
                        </div>
                        {items &&
                            items.length > 0 &&
